...
if __name__ == '__main__':
    # 测试参数
    test_params = {
        'checkpoint_path': r'F:\RA-MED\Set Transformer\keypoint_detection\checkpoints\best_model.pth',
        'test_dir': r'F:\RA-MED\Set Transformer\keypoint_detection\data\test',
        'results_dir': r'F:\RA-MED\Set Transformer\keypoint_detection\test_results',
        'batch_size': 8,
